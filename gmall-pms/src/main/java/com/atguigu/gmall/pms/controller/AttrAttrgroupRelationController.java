...
public class AttrAttrgroupRelationController {
    ...
    {
        this.attrAttrgroupRelationService.remove(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_group_id", relationEntities.get(0).getAttrGroupId()).eq("attr_id", relationEntities.get(0).getAttrId()));
